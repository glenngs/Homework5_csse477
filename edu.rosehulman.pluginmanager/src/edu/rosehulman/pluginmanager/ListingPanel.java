...
public class ListingPanel extends JPanel implements Runnable {
            ...
            public void valueChanged(ListSelectionEvent arg0) {
                if (!arg0.getValueIsAdjusting()) {
                	...
                	if(dataList.getSelectedValue() != null) {
                		...
                		//This means that the selected plugin was deleted.  I'm not sure what to do in this case but we should handle it.
                		label.setText("None");
                	}
                }
            }
	...
	public void addPlugin(File jarfile) {
		...
		//TODO Gabe: Right now, I am importing Counter and just assuming that all added jars are of that type for testing my part
		// You need to make it so it uses reflection to get the actual class instead from the plugin
